...
In Drupal you can create base themes and subthemes. A base theme provides some set of predefined styles and functionality that a frontend developer can base a subtheme on. Any theme can be used as a base theme, even if it is a subtheme of some other theme.

## Core Themes

Drupal comes with preloaded themes, located in `core/themes/`.

1. **Stable9**: Stable 9 allows core markup and styling to evolve by functioning as a backwards
...
1. **Starterkit** The Starterkit theme is not directly used by Drupal, nor is it used as a base theme.
...
5. **Stark**: The Stark theme is provided for demonstration purposes; it uses Drupal's
...
**Claro** This theme is marked as internal. It is intended to evolve and change over minor releases.

**Olivero** This theme is marked as internal. It is intended to evolve and change over minor releases.

**Classy** Classy theme is deprecated https://www.drupal.org/node/3313997
...
`Stable9` and `StarterKit` are the two standard base themes provided out of the box, although you could technically use any theme as a base theme if you really wanted to.

The reason Drupal provides two base themes is to appeal to two different groups of developers:
...
As a compromise, `Stable9` was established for the minimalists, and `StarterKit` is for those wanting sensible a 100% Clean experience to start.
...
From [Working with breakpoints in Drupal 8](https://www.drupal.org/docs/theming-drupal/working-with-breakpoints-in-drupal):
...
- [drupal.org - Adding Stylesheets (CSS) and JavaScript (JS) to a Drupal theme](https://www.drupal.org/docs/develop/theming-drupal/adding-assets-css-js-to-a-drupal-theme-via-librariesyml)
- [drupal.org - Sub-theming: Using Stable/Stable 9 as a base theme](https://www.drupal.org/docs/develop/theming-drupal/sub-theming-using-stablestable-9-as-a-base-theme)
- [drupal.org - Working with breakpoints in Drupal](https://www.drupal.org/docs/theming-drupal/working-with-breakpoints-in-drupal)
